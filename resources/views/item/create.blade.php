...
@section('content')
    <div class="container" id="container-item">
        <div class="row">
            <h4>Novo item</h4>
            <div class="col-md-12">
                <form id="my-form" action="{{route('items.store')}}" method="post" @submit.prevent="onsubmit()">
                    {{csrf_field()}}
                    ...
                    <div class="form-group">
                        ...
                        <table class="table">
                            ...
                            <tr v-for="(valor,key) in valores">
                                ...
                                <td>
                                    <input class="form-control" type="number" :name="'valores['+key+'][valor]'" step="any" min="1"/>
                                </td>
                                <td>
                                    <input class="form-control" type="number" :name="'valores['+key+'][volume]'" step="1" min="1"/>
                                </td>
                            </tr>
                            </tbody>
                        </table>
